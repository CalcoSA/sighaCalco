...
from app.api.userController import router as UserRouter
...
app = FastAPI(title="SighaCalco Authentication API", version="1.0.0")
...
def root():
    ...
    return { "message": "API sighaCalco.Authentication funcionando correctamente" }